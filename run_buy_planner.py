...
if __name__ == "__main__" and not (sys.flags.isolated and sys.flags.no_site and sys.dont_write_bytecode):
    print("Use: python -I -S -B run_buy_planner.py [snapshot.json | --demo | --verify | --export | --menu]")
    raise SystemExit(2)
import hashlib
import json
import os
...
PACKAGE_ID = "KALSHI_10X1C_PUBLIC"
MAX_INPUT = 65536
...
def verify_release():
    ...
    try:
        ...
        required = {"run_buy_planner.py", "VERSION.txt", "PACKAGE_METADATA.json", "SBOM.cdx.json", "LICENSE"}
...
SUPPORT_SHA256 = "4b85f609a821ca936f97a078a6a026e2d136d38dac037f1eec8dd01f6d3b78d0"
_SUPPORT = None
...
def main(args=None):
    ...
    if args in ([], ["--demo"]):
        path = ROOT / "examples" / "eligible_snapshot.json"
